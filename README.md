...
$config = [
    ...
    'credentials' => new AccessTokenAuthentication('Vdheub7w9bIut67GHeL345gfb5GAnd3dZnf08FRbvjeUFvetYiohGvc')
];
...
$config = [
    ...
    'credentials' => new OAuthTokenAuthentication('y3_Vdheub7w9bIut67GHeL345gfb5GAnd3dZnf08FRbvjeUFvetYiohGvc')
];
