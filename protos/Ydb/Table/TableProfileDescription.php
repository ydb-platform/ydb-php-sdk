...
class TableProfileDescription extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $allowed_storage_policies
     *     @type string $default_compaction_policy
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $allowed_compaction_policies
     *     @type string $default_partitioning_policy
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $allowed_partitioning_policies
     *     @type string $default_execution_policy
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $allowed_execution_policies
     *     @type string $default_replication_policy
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $allowed_replication_policies
     *     @type string $default_caching_policy
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $allowed_caching_policies
     * }
     */
