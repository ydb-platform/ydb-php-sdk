...
class AlterTableRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $path
     *           Full path
     *     @type \Ydb\Table\ColumnMeta[]|\Google\Protobuf\Internal\RepeatedField $add_columns
     *           Columns (name, type) to add
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $drop_columns
     *           Columns to remove
     *     @type \Ydb\Operations\OperationParams $operation_params
     *     @type \Ydb\Table\ColumnMeta[]|\Google\Protobuf\Internal\RepeatedField $alter_columns
     *           Columns to alter
     *     @type \Ydb\Table\TtlSettings $set_ttl_settings
     *     @type \Google\Protobuf\GPBEmpty $drop_ttl_settings
     *     @type \Ydb\Table\TableIndex[]|\Google\Protobuf\Internal\RepeatedField $add_indexes
     *           Add secondary indexes
     *     @type string[]|\Google\Protobuf\Internal\RepeatedField $drop_indexes
     *           Remove secondary indexes
     *     @type \Ydb\Table\StorageSettings $alter_storage_settings
     *           Change table storage settings
     *     @type \Ydb\Table\ColumnFamily[]|\Google\Protobuf\Internal\RepeatedField $add_column_families
     *           Add/alter column families
     *     @type \Ydb\Table\ColumnFamily[]|\Google\Protobuf\Internal\RepeatedField $alter_column_families
    ...
    {
        return isset($this->alter_storage_settings) ? $this->alter_storage_settings : null;
    }
     ...
     *
     * Generated from protobuf field <code>repeated .Ydb.Table.ColumnFamily add_column_families = 12;</code>
     * @param \Ydb\Table\ColumnFamily[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
     ...
     *
     * Generated from protobuf field <code>.Ydb.Table.PartitioningSettings alter_partitioning_settings = 16;</code>
     * @return \Ydb\Table\PartitioningSettings
     */
    public function getAlterPartitioningSettings()
    {
        return isset($this->alter_partitioning_settings) ? $this->alter_partitioning_settings : null;
    }
     ...
     *
     * Generated from protobuf field <code>.Ydb.Table.ReadReplicasSettings set_read_replicas_settings = 18;</code>
     * @return \Ydb\Table\ReadReplicasSettings
     */
    public function getSetReadReplicasSettings()
    {
        return isset($this->set_read_replicas_settings) ? $this->set_read_replicas_settings : null;
    }
