...
class DescribeTableResult extends \Google\Protobuf\Internal\Message
{
     ...
     *           List of key ranges for shard
     *     @type \Ydb\Table\TableIndexDescription[]|\Google\Protobuf\Internal\RepeatedField $indexes
     *           List of indexes
     ...
     *           Storage settings for table
     *     @type \Ydb\Table\ColumnFamily[]|\Google\Protobuf\Internal\RepeatedField $column_families
     *           Column families
     ...
     *
     * Generated from protobuf field <code>repeated .Ydb.Table.TableIndexDescription indexes = 5;</code>
     * @param \Ydb\Table\TableIndexDescription[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    {
        return isset($this->storage_settings) ? $this->storage_settings : null;
    }
    ...
    {
        return isset($this->partitioning_settings) ? $this->partitioning_settings : null;
    }
    ...
    {
        return isset($this->read_replicas_settings) ? $this->read_replicas_settings : null;
    }
