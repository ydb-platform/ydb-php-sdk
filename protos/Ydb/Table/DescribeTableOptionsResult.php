...
class DescribeTableOptionsResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Ydb\Table\TableProfileDescription[]|\Google\Protobuf\Internal\RepeatedField $table_profile_presets
     *     @type \Ydb\Table\StoragePolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $storage_policy_presets
     *     @type \Ydb\Table\CompactionPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $compaction_policy_presets
     *     @type \Ydb\Table\PartitioningPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $partitioning_policy_presets
     *     @type \Ydb\Table\ExecutionPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $execution_policy_presets
     *     @type \Ydb\Table\ReplicationPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $replication_policy_presets
     *     @type \Ydb\Table\CachingPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $caching_policy_presets
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Ydb.Table.TableProfileDescription table_profile_presets = 1;</code>
     * @param \Ydb\Table\TableProfileDescription[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Ydb.Table.StoragePolicyDescription storage_policy_presets = 2;</code>
     * @param \Ydb\Table\StoragePolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Ydb.Table.CompactionPolicyDescription compaction_policy_presets = 3;</code>
     * @param \Ydb\Table\CompactionPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Ydb.Table.PartitioningPolicyDescription partitioning_policy_presets = 4;</code>
     * @param \Ydb\Table\PartitioningPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Ydb.Table.ExecutionPolicyDescription execution_policy_presets = 5;</code>
     * @param \Ydb\Table\ExecutionPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Ydb.Table.ReplicationPolicyDescription replication_policy_presets = 6;</code>
     * @param \Ydb\Table\ReplicationPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Ydb.Table.CachingPolicyDescription caching_policy_presets = 7;</code>
     * @param \Ydb\Table\CachingPolicyDescription[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
