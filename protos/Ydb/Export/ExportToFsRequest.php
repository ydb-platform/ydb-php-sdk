...
/**
 * Generated from protobuf message <code>Ydb.Export.ExportToFsRequest</code>
 */
class ExportToFsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.Ydb.Export.ExportToFsSettings settings = 2 [(.Ydb.required) = true];</code>
     */
     ...
     *     @type \Ydb\Export\ExportToFsSettings $settings
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.Ydb.Export.ExportToFsSettings settings = 2 [(.Ydb.required) = true];</code>
     * @return \Ydb\Export\ExportToFsSettings|null
     */
    ...
    /**
     * Generated from protobuf field <code>.Ydb.Export.ExportToFsSettings settings = 2 [(.Ydb.required) = true];</code>
     * @param \Ydb\Export\ExportToFsSettings $var
     * @return $this
     */
    public function setSettings($var)
    {
        GPBUtil::checkMessage($var, \Ydb\Export\ExportToFsSettings::class);
        $this->settings = $var;
