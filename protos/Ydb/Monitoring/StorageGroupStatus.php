...
class StorageGroupStatus extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $id
     *     @type int $overall
     *     @type \Ydb\Monitoring\StorageVDiskStatus[]|\Google\Protobuf\Internal\RepeatedField $vdisks
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Ydb.Monitoring.StorageVDiskStatus vdisks = 3;</code>
     * @param \Ydb\Monitoring\StorageVDiskStatus[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
