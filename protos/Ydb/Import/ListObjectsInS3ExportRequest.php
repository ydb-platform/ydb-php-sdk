...
/**
 * Generated from protobuf message <code>Ydb.Import.ListObjectsInS3ExportRequest</code>
 */
class ListObjectsInS3ExportRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.Ydb.Import.ListObjectsInS3ExportSettings settings = 2 [(.Ydb.required) = true];</code>
     */
     ...
     *     @type \Ydb\Import\ListObjectsInS3ExportSettings $settings
    ...
    /**
     * Generated from protobuf field <code>.Ydb.Import.ListObjectsInS3ExportSettings settings = 2 [(.Ydb.required) = true];</code>
     * @return \Ydb\Import\ListObjectsInS3ExportSettings|null
     */
    ...
    /**
     * Generated from protobuf field <code>.Ydb.Import.ListObjectsInS3ExportSettings settings = 2 [(.Ydb.required) = true];</code>
     * @param \Ydb\Import\ListObjectsInS3ExportSettings $var
     * @return $this
     */
    public function setSettings($var)
    {
        GPBUtil::checkMessage($var, \Ydb\Import\ListObjectsInS3ExportSettings::class);
        $this->settings = $var;
