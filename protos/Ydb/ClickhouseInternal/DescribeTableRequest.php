...
/**
 * Generated from protobuf message <code>Ydb.ClickhouseInternal.DescribeTableRequest</code>
 */
class DescribeTableRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $path = '';
    /**
     * Generated from protobuf field <code>bool include_partitions_info = 3;</code>
     */
    protected $include_partitions_info = false;
     ...
     *     @type string $path
     *     @type bool $include_partitions_info
     * }
     */
     ...
     * @return bool
     */
    public function getIncludePartitionsInfo()
    {
        return $this->include_partitions_info;
    }
     ...
     * @return $this
     */
    public function setIncludePartitionsInfo($var)
    {
        GPBUtil::checkBool($var);
        $this->include_partitions_info = $var;
