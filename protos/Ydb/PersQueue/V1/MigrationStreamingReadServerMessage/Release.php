 ...
 *
 * Generated from protobuf message <code>Ydb.PersQueue.V1.MigrationStreamingReadServerMessage.Release</code>
 */
class Release extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>bool forceful_release = 6;</code>
     */
    protected $forceful_release = false;
    /**
     ...
     * @return bool
     */
    public function getForcefulRelease()
    {
        return $this->forceful_release;
    }
     ...
     * @return $this
     */
    public function setForcefulRelease($var)
    {
        GPBUtil::checkBool($var);
        $this->forceful_release = $var;
...
class_alias(Release::class, \Ydb\PersQueue\V1\MigrationStreamingReadServerMessage_Release::class);
