...
namespace Ydb\PersQueue\V1\StreamingReadClientMessageNew\InitRequest\State;
...
/**
 * Generated from protobuf message <code>Ydb.PersQueue.V1.StreamingReadClientMessageNew.InitRequest.State.PartitionStreamState</code>
 */
class PartitionStreamState extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.Ydb.PersQueue.V1.StreamingReadClientMessageNew.InitRequest.State.PartitionStreamState.Status status = 4;</code>
     */
    protected $status = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Ydb\PersQueue\V1\StreamingReadClientMessageNew\InitRequest\State\PartitionStreamState\Status::class);
        $this->status = $var;
...
class_alias(PartitionStreamState::class, \Ydb\PersQueue\V1\StreamingReadClientMessageNew_InitRequest_State_PartitionStreamState::class);
