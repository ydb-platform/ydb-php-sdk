 ...
 * Handshake response.
 *
 * Generated from protobuf message <code>Ydb.PersQueue.V1.StreamingReadServerMessageNew.InitResponse</code>
 */
...
class_alias(InitResponse::class, \Ydb\PersQueue\V1\StreamingReadServerMessageNew_InitResponse::class);
