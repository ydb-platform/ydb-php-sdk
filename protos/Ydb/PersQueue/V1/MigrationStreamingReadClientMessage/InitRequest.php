 ...
 * Handshake request.
 *
 * Generated from protobuf message <code>Ydb.PersQueue.V1.MigrationStreamingReadClientMessage.InitRequest</code>
 */
class InitRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .Ydb.PersQueue.V1.MigrationStreamingReadClientMessage.TopicReadSettings topics_read_settings = 1;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.Ydb.PersQueue.V1.MigrationStreamingReadClientMessage.InitRequest.State state = 102;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.Ydb.PersQueue.V1.ReadParams read_params = 42;</code>
     */
    protected $read_params = null;
    /**
     *&#47;/////////////////////////////////////////////////////////////////////////////////////////////////////////
     *
     * Generated from protobuf field <code>bool ranges_mode = 442;</code>
     */
    protected $ranges_mode = false;
     ...
     *
     *     @type \Ydb\PersQueue\V1\MigrationStreamingReadClientMessage\TopicReadSettings[]|\Google\Protobuf\Internal\RepeatedField $topics_read_settings
     *           Message that describes topic to read.
     *           Topics that will be read by this session.
     ...
     *           0 for first init message and incremental value for connect retries.
     *     @type \Ydb\PersQueue\V1\MigrationStreamingReadClientMessage\InitRequest\State $state
     *           Formed state for retries. If not retry - do not use this field.
     *     @type int|string $idle_timeout_ms
     *     @type \Ydb\PersQueue\V1\ReadParams $read_params
     *          &#47;/////////////////////////////////////////////////////////////////////////////////////////////////////////
     *           TODO: remove after refactoring
     *           Single read request params.
     *     @type bool $ranges_mode
     *          &#47;/////////////////////////////////////////////////////////////////////////////////////////////////////////
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .Ydb.PersQueue.V1.MigrationStreamingReadClientMessage.TopicReadSettings topics_read_settings = 1;</code>
     * @param \Ydb\PersQueue\V1\MigrationStreamingReadClientMessage\TopicReadSettings[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTopicsReadSettings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Ydb\PersQueue\V1\MigrationStreamingReadClientMessage\TopicReadSettings::class);
     ...
     *
     * Generated from protobuf field <code>.Ydb.PersQueue.V1.MigrationStreamingReadClientMessage.InitRequest.State state = 102;</code>
     * @return \Ydb\PersQueue\V1\MigrationStreamingReadClientMessage\InitRequest\State
     */
     ...
     *
     * Generated from protobuf field <code>.Ydb.PersQueue.V1.MigrationStreamingReadClientMessage.InitRequest.State state = 102;</code>
     * @param \Ydb\PersQueue\V1\MigrationStreamingReadClientMessage\InitRequest\State $var
     * @return $this
     */
    public function setState($var)
    {
        GPBUtil::checkMessage($var, \Ydb\PersQueue\V1\MigrationStreamingReadClientMessage\InitRequest\State::class);
        $this->state = $var;
     ...
     *
     * Generated from protobuf field <code>.Ydb.PersQueue.V1.ReadParams read_params = 42;</code>
     * @return \Ydb\PersQueue\V1\ReadParams
     */
    public function getReadParams()
    {
        return isset($this->read_params) ? $this->read_params : null;
    }

    public function hasReadParams()
    {
        return isset($this->read_params);
    }

    public function clearReadParams()
    {
        unset($this->read_params);
    }
     ...
     *
     * Generated from protobuf field <code>.Ydb.PersQueue.V1.ReadParams read_params = 42;</code>
     * @param \Ydb\PersQueue\V1\ReadParams $var
     * @return $this
     */
    public function setReadParams($var)
    {
        GPBUtil::checkMessage($var, \Ydb\PersQueue\V1\ReadParams::class);
        $this->read_params = $var;
     ...
     * @return bool
     */
    public function getRangesMode()
    {
        return $this->ranges_mode;
    }
     ...
     * @return $this
     */
    public function setRangesMode($var)
    {
        GPBUtil::checkBool($var);
        $this->ranges_mode = $var;
...
class_alias(InitRequest::class, \Ydb\PersQueue\V1\MigrationStreamingReadClientMessage_InitRequest::class);
