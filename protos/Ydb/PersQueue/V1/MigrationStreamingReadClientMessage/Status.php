...
/**
 * Generated from protobuf message <code>Ydb.PersQueue.V1.MigrationStreamingReadClientMessage.Status</code>
 */
...
class_alias(Status::class, \Ydb\PersQueue\V1\MigrationStreamingReadClientMessage_Status::class);
