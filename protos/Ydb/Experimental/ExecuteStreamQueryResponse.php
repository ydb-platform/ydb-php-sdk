...
/**
 * Generated from protobuf message <code>Ydb.Experimental.ExecuteStreamQueryResponse</code>
 */
class ExecuteStreamQueryResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    private $issues;
    /**
     * Generated from protobuf field <code>.Ydb.Experimental.ExecuteStreamQueryResult result = 3;</code>
     */
     ...
     *     @type \Ydb\Experimental\ExecuteStreamQueryResult $result
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.Ydb.Experimental.ExecuteStreamQueryResult result = 3;</code>
     * @return \Ydb\Experimental\ExecuteStreamQueryResult
     */
    ...
    /**
     * Generated from protobuf field <code>.Ydb.Experimental.ExecuteStreamQueryResult result = 3;</code>
     * @param \Ydb\Experimental\ExecuteStreamQueryResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Ydb\Experimental\ExecuteStreamQueryResult::class);
        $this->result = $var;
