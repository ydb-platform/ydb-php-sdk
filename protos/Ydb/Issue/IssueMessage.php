...
class IssueMessage extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.Ydb.Issue.IssueMessage.Position position = 1;</code>
     * @return \Ydb\Issue\IssueMessage\Position
     */
    ...
    {
        return isset($this->issue_code) ? $this->issue_code : 0;
    }

    public function hasIssueCode()
    {
        return isset($this->issue_code);
    }

    public function clearIssueCode()
    {
        unset($this->issue_code);
    }
